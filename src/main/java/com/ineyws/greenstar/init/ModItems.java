...
public class ModItems {
    ...
    // BlockItem для блока зеленого металла
    public static final RegistryObject<BlockItem> GREEN_BLOCK_ITEM = ITEMS.register("green_block",
            () -> new BlockItem(ModBlocks.GREEN_BLOCK.get(), 
                    new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
    ...
    // BlockItem для руды бедрока
    public static final RegistryObject<BlockItem> BEDROCK_ORE_ITEM = ITEMS.register("bedrock_ore",
            () -> new BlockItem(ModBlocks.BEDROCK_ORE.get(), 
                    new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
